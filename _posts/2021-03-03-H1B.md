---
layout: post
title: Predicting H1B Visa Applications (2011-2016)
subtitle: -----
...
The original dataset has 3 million rows, so I got a sample of 500000 rows.

The data, i.e., the column that is to be the target, is imbalanced; over 80% of it is “CERTIFIED”, so it is questionable whether accuracy is the best arbiter.
...
Rate of certification was more or less constant.
...
<img src = "/assets/h1b/#applicantswagegroups.png">
...
<img src = "/assets/h1b/%applicantswagegroups.png.png">
...
<img src = "/assets/h1b/#applicantsocctype.png">
