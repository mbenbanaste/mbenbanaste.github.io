...
The dataset at hand contains information on H1B Visa applications between 2011-2016.
...
Crucially, the data, i.e., the column that is to be the target, is imbalanced; over 80% of it is “CERTIFIED”, so it is questionable whether accuracy score is the best arbiter for predictive models.
